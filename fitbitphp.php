<?php
	...
	class FitBitPHP {
		...
		public function logActivity($date, $activityId, $duration, $calories = null, $distance = null, $distanceUnit = null, $activityName = null) {
			$distanceUnits = ['Centimeter', 'Foot', 'Inch', 'Kilometer', 'Meter', 'Mile', 'Millimeter', 'Steps', 'Yards'];

			$headers = $this->getHeaders();
			$parameters = [];
			$date = new DateTime($date);//James added see http://php.net/datetime.format
		 ...
		 */
		public function customCall($url, $parameters, $method, $userHeaders = []) {
			$headers = $this->getHeaders();
			$headers = array_merge($headers, $userHeaders);
		 ...
		 * @return FitBitResponse
		 */
		public function client_customCall($url, $parameters, $method, $userHeaders = []) {
